...
class Track:
    ...
    def __init__(self, bbox, frame_id, track_id, det_class):
    ...
    def update(self, box, frame_id, det_class):
...
class SFSORT:
    ...
    def update(self, boxes, scores, det_class):
        ...
        if high_score.any():
            ...
            definite_classes  = det_class[high_score]  
            if track_pool:           
                ...
                for track_idx, detection_idx in matches:
                    ...
                    track.update(box, self.frame_no, cls)
                ...
                for detection_idx in unmatched_detections:                   
                    if definite_scores[detection_idx] > nth:
                        box = definite_boxes[detection_idx]
                        cls = definite_classes[detection_idx]
                        track = Track(box, self.frame_no, self.id_counter, cls)
                        next_active_tracks.append(track)
                        self.id_counter += 1                   
            else:
        ...
        if intermediate_score.any(): 
            if len(unmatched_tracks):                 
                ...
                possible_cls = det_class[intermediate_score]
                ...
                for track_idx, detection_idx in matches:
                    ...
                    cls = possible_cls[detection_idx]
        ...
        return np.asarray([[x.bbox, x.track_id, x.det_class] for x in next_active_tracks], dtype=object)
